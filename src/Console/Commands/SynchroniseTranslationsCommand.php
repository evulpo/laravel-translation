...
class SynchroniseTranslationsCommand extends Command
{
    ...
    public function handle()
    {
        ...
        // When the from driver will be entered manually or if the argument is invalid.
            ...
            $this->fromDriver = $this->anticipate(__('Which driver would you like to take translations from?'), $this->drivers);

            if (! in_array($this->fromDriver, $this->drivers)) {
                return $this->error(__('Invalid driver'));
            }
        }
        ...
        // When the to driver will be entered manually.
            ...
            $this->toDriver = $this->anticipate(__('Which driver would you like to add the translations to?'), $this->drivers);
        ...
        if ($this->argument('language')) {
            ...
            elseif (in_array($this->argument('language'), $languages)) {
                ...
                return $this->error(__('Invalid language'));
            }
        } // When the language will be entered manually or if the argument is invalid.
        else {
            $language = $this->anticipate(__('Which language? (leave blank for all)'), $languages);
        ...
        $this->line(__('Syncing translations ⏳'));
        ...
        $this->info(__('Translations have been synced 😎'));
    }
